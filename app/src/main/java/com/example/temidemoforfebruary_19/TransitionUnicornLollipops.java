...
public class TransitionUnicornLollipops extends TransitionDemo{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.unicorn_lollipops_face);
        ...
        faceFragmentFrame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (state == States.INIT){
                    ...
                    startActivity(new Intent(TransitionUnicornLollipops.this, TransitionStart.class));
                    finish();
                }
