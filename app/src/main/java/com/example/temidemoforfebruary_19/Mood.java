...
public enum Mood {
    ...
    LISTENING(R.drawable.base_eyebrow, R.drawable.rise_eyebrow_r_0005,
            R.drawable.sad_eye0000, R.drawable.normal_eye0000,
            R.drawable.surprise_mouth_0003),

    DRAWING(R.drawable.base_eyebrow, R.drawable.base_eyebrow,
            R.drawable.eyes_almost_closed_01, R.drawable.eyes_almost_closed_01,
